...
class AlertService:
    ...
    async def get_predefined_metrics(self,user_id:str) -> List[Dict[str, Any]]:
        """
    ...
    async def create_alert(self, alert_data: AlertCreate, user_id: str) -> Dict[str, Any]:
        """
    ...
    # ✅ NEW
    async def get_alert(self, alert_id: int, user_id: str) -> Dict[str, Any]:
        """Get alert by ID"""
    ...
    async def update_alert(self, alert_id: int, update_data: Dict[str, Any], user_id: str) -> Dict[str, Any]:
    ...
    async def delete_alert(self, alert_id: int, user_id: str) -> bool:
        ...
        try:
            async with httpx.AsyncClient(timeout=self.timeout) as client:
                response = await client.delete(url, headers=self._get_headers(user_id))
                response.raise_for_status()
                return True
        except Exception as e:
